 ...
 */
function create_tables($db, $prefix = 'sys_'){
    //读取SQL文件
...
function register_administrator($db, $prefix="sys_", $admin, $auth){
    show_msg('开始注册创始人帐号...');
 ...
 */
function update_tables($db, $prefix = 'sys_'){
    //读取SQL文件
