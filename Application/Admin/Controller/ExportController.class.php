...
//            $map['register_way'] = $_REQUEST['register_way'];
              ...
              $xlsData = M('user', 'tab_')->field('tab_user.*,FROM_UNIXTIME(register_time,\'%Y-%m-%d %H:%i:%s\') as register_time,IFNULL( IFNULL(sum(b.pay_amount),0)+IFNULL(sum(c.pay_amount),0),0) AS recharge_total')
